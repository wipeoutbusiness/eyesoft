  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="font-bold text-emerald-900 text-base">Camera Fund</h3>
      </div>
      <p className="text-sm text-emerald-800 mb-2 leading-snug">Help us upgrade our equipment!</p>
      ...
      <div className="flex justify-between mt-1 text-sm">
        ...
        <span className="text-emerald-900 font-semibold">Goal: ${goal}</span>
      </div>
    </motion.div>
  );
}
